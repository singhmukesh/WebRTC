Ext.define('videochat.view.chat.RoomsContainerController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.chatroomscontainer',
    mixins: ['opentok.OpenTokMixin'],

    //TODO : refactor this out to auth package since it's based on app setup not video chat
...
/*
    ...
    */
    ...
    onFilterFieldChange: function(field, value) {
        var me = this,
            list = me.getReferences().roomsgrid;
    ...
    onFilterClearTriggerClick: function() {
        this.getReferences().roomFilter.setValue();
    },

    onFilterSearchTriggerClick: function() {
        var field = this.getReferences().roomFilter;
    ...
    filterStore: function(value) {
        ...
        if (!Ext.isEmpty(value)) {
            store.filterBy(function (rec) {
                ...
                if(data){
                    return data['name'].toLowerCase().indexOf(value.toLowerCase()) > -1 || data['topic'].toLowerCase().indexOf(value.toLowerCase()) > -1;
                }else{
                    return false
                }
            });
